...
import { FileOutput, ScanText, Wand2, Merge, Split, ImageDown, Minimize2 } from "lucide-react";
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
        {actions.map((action, i) => (
          <motion.button
            ...
            whileTap={{ scale: 0.97 }}
            className="flex flex-col items-center gap-2 p-4 rounded-lg bg-secondary/50 hover:bg-secondary border border-border/50 hover:border-border transition-all"
          >
